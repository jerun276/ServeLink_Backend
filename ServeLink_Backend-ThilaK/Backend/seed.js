...
const seedDatabase = async () => {
  try {
    ...
    const provider1 = await Provider.create({
      ...
      nicImageUrl: 'https://res.cloudinary.com/demo/image/fetch/w_200,h_200/https://servelink.lk/samples/nic-plumbing.jpg',
      businessRegUrl: 'https://res.cloudinary.com/demo/image/fetch/w_200,h_200/https://servelink.lk/samples/business-reg-plumbing.jpg',
      hasBusinessReg: true,
      verificationStatus: 'approved',
      serviceCategories: ['plumbing', 'electrical'],
      district: 'Colombo',
      bio: 'Professional plumber with 10 years experience in residential and commercial plumbing services',
      avgRating: 4.8,
      totalReviews: 24,
      verifiedAt: new Date(),
    })
    ...
    const provider2 = await Provider.create({
      ...
      nicImageUrl: 'https://res.cloudinary.com/demo/image/fetch/w_200,h_200/https://servelink.lk/samples/nic-electrical.jpg',
      businessRegUrl: '',
      hasBusinessReg: false,
      verificationStatus: 'approved',
      serviceCategories: ['electrical', 'ac_repair'],
      district: 'Kandy',
      bio: 'Certified electrician specializing in home electrical installations and repairs',
      avgRating: 4.6,
      totalReviews: 18,
      verifiedAt: new Date(),
    })
